<template>
  ...
  >
    <div class="wrap relative">
      ...
      <h2 class="title text-center mx-auto">How much do you weigh?</h2>
      <form action="">
        <div class="user-info">
          <input type="text" placeholder="175" />
          <span class="unit">Kg</span>
        </div>
        <div class="radio-wrap">
          <span class="rounded-full btn-height active">Kg</span>
          <span class="rounded-full btn-height">Lb</span>
        </div>
      </form>
    </div>
    <div class="btn-wrap">
